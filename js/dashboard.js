window.onload = function() {
  ...
  },
  {
    ...
    'credit_bild':'By The original uploader was Galilea at German Wikipedia - First upload to Wikipedia: de.wikipedia; description page is/was here.(Original text: Fotografiert am 30.03.2005) Second upload to Commons: http://commons.wikimedia.org/wiki/Image:Kapitolinischer_Pythagoras.jpg and this is an adjusted version of the second one., CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=2580073',
    'prolog_text': 'Johann Carl Friedrich Gau&szlig; (der F&uuml;rst der Mathematiker) ist mein Name und ich bin der genialste Kopf meiner Zeit. Ich bin nicht nur unglaublich schlau sondern auch von erhabenem Ehrgeiz durchstr&ouml;mt. "Man kann mit der Wurzel aus -1 nichts anfangen" haben sie gesagt, Man muss akzeptieren, dass es Grenzen gibt" haben sie gesagt. Ich habe nicht akzeptiert, dass es Grenzen gibt und den Komplexen Zahlenraum begr&uuml;ndet. Des Weiteren habe ich die Mathematik in vielen weiteren Bereichen revolutioniert: nicht-euklidische Geometrie, euklidische Konstruktion, Primzahlenverteilung, Wahrscheinlichkeitsrechnung, Eliptische Funktionen & Algebra um nur ein paar zu nennen. wenn ich in der heutigen Zeit geboren w&auml;re, h&auml;tten wir fliegende Autos und den Warp-Antrieb. Um dich zu besiegen verwende ich mein eigenes Eliminationsverfahren.',
    'epilog_text': 'Oh nein du hast mich besiegt! das hei&szlig;t wohl das du keine lineare Gleichung bist. Ich habe dich untersch&auml;tzt. ich werde meine mathematischen Kollegen warnen, damit sie dich aufhalten k&ouml;nnen.',
  },
  {
  ...
  },
  {
    ...
    'prolog_text': 'Gr&uuml;&szlig;e, Suchender! Mein Name ist Leonardo da Pisa, oder auch Fibonacci, wie mich die Untertanen nennen! Noch heute kann man meine Statue im Campo Santo in Pisa begutachter! Im Jahre 1202 erfand ich die Fibonacci-Folge, um das exponentielle Wachstum von Kaninchen den Niederbemittelten darzustellen. Diese Erfindung war so genial, dass noch heute in eurem "Mathematik"-Unterricht versucht wird, sie zu ergr&uuml;nder! Ich nehme jede Herausforderung an, in der Hoffnung, dass einer von euch mich &uuml;bertrumpfen kann. Jedoch habe ich wenig Glauben daran, ein solche Vorkommnis noch zu erleben.',
  ...
  },
  {
    ...
    'prolog_text': 'Man spricht mich mit "Sir Isaac Newton" an. Ja, ich wurde zum Ritter geschlagen und das ist die geringste Errungenschaft meines Lebens. Ich hab die Gesetze der Optik ergr&uuml;ndet. Dass wir Wissen das wei&szlig;es Licht aus der Überlappung des gesamten sichtbaren Spektrums besteht, ist mir zu verdanken und dann w&auml;re da noch die Sache mit der Gravitation. Ein Freund fragte mich einst, warum sich Planeten in elliptischen Umlaufbahnen bewegen. Also erfand ich den n&auml;chsten Wochen die Integral- und Differentialrechnung. All das war vor meinem 26. Geburtstag. Die meisten Leute schaffen es nicht einmal die mathematischen Grunds&auml;tze, die ich in meiner Jugend begr&uuml;ndet habe, in ihrer geistigen H&ouml;he zu verstehen. Bevor du gegen mich gewinnst, werde ich von einem Apfel erstochen!',
  ...
  },
  {
    ...
    'epilog_text': 'Du hast wirklich so viele Punkte gesammelt um uns zu &uuml;bertrumpfen, nicht schlecht. Oder hast du vielleicht einfach geschummelt? :^) Wie auch immer, bei der Schularbeit, kannst du das nicht bringen, du kleiner Wicht :).',
}
]
};
