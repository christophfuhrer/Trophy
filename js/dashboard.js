window.onload = function() {
  ...
  [
  {
    ...
    'required_points':'xx',
    'bild': 'images/mathematiker_final/pythagoras.jpg',
  ...
  },
  {
    ...
    'required_points':'xx',
    'bild': 'images/mathematiker_final/gauss.jpg',
  ...
  },
  {
    ...
    'required_points':'xx',
    'bild': 'images/mathematiker_final/leibniz.jpg',
    'trophy': 'images/trophies/gauss_trophy.svg',
  ...
  },
  {
    'name':'Fibonacci',
    'required_points':'xx',
    'bild': 'images/mathematiker_final/fibonacci.jpg',
  ...
  },
  {
    'name':'Leonard Euler',
    'required_points':'xx',
    'bild': 'images/mathematiker_final/euler.jpg',
  ...
  },
  {
    ...
    'required_points':'xx',
    'bild': 'images/mathematiker_final/newton.jpg',
  ...
  },
  {
    ...
    'required_points': 'xx',
    'bild':'images/mathematiker_final/kauer_javurek.jpg',
  ...
  function loadMaths(){
    ...
    for(var i = 0; i < mathe_json.mathematiker.length(); i++){
      ...
      boxTemplate = '<div class="row"><div class="box imagebox"><img src="' + path + '" class="mathematic"/></div><div class="box textbox"><div><h1>' + name + '</h1><p>' + text + '</p></div></div></div>';
        ...
        document.getElementById('content_tower').appendChild(boxTemplate);
    }
  }
